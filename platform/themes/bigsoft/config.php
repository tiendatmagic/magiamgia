...
return [
    ...
    'events' => [
        ...
        'beforeRenderTheme' => function (Theme $theme) {
            ...
            $theme->asset()->container('footer')->usePath()->add('wow.js', 'js/wow.js', ['jquery'], [], $version);
            $theme->asset()->container('footer')->usePath()->add('swiper.js', 'js/swiper.js', ['jquery'], [], $version);
            $theme->asset()->container('footer')->usePath()->add('fancybox.umd.js', 'js/fancybox.umd.js', ['jquery'], [], $version);
            $theme->asset()->container('footer')->usePath()->add('boostrap.js', 'js/bootstrap.js', ['jquery'], [], $version);
            $theme->asset()->container('footer')->usePath()->add('bootstrap-datepicker.min.js', 'js/bootstrap-datepicker.min.js', ['jquery'], [], $version);
            ...
            $theme->asset()->usePath()->add('swiper', 'css/swiper.css');
            $theme->asset()->usePath()->add('fancybox', 'css/fancybox.css');
            $theme->asset()->usePath()->add('fancybox', 'css/bootstrap-datepicker.min.css');

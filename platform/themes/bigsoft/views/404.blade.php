        ...
        <div class="page-content error-page">
            ...
            <div class="tw-mx-auto tw-mt-6 tw-text-center">
                <a href="{{ BaseHelper::getHomepageUrl() }}"
                    class="tw-py-[13px] tw-px-[20px] tw-text-white lg:tw-m-0 tw-inline tw-border-0 tw-overflow-hidden tw-cursor-pointer tw-no-underline tw-bg-[#005ae0] hover:tw-bg-[#f97e2b] tw-rounded-full tw-font-medium">{{ __('Back to Homepage') }}</a>
            </div>
